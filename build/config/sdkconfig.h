...
#define CONFIG_BT_CLASSIC_BQB_ENABLED 1
#define CONFIG_BT_A2DP_ENABLE 1
#define CONFIG_BT_AVRCP_ENABLED 1
#define CONFIG_BT_SPP_ENABLED 1
#define CONFIG_BT_L2CAP_ENABLED 1
#define CONFIG_BT_SDP_COMMON_ENABLED 1
#define CONFIG_BT_LOG_HCI_TRACE_LEVEL_VERBOSE 1
#define CONFIG_BT_LOG_HCI_TRACE_LEVEL 6
#define CONFIG_BT_LOG_BTM_TRACE_LEVEL_VERBOSE 1
#define CONFIG_BT_LOG_BTM_TRACE_LEVEL 6
#define CONFIG_BT_LOG_L2CAP_TRACE_LEVEL_VERBOSE 1
#define CONFIG_BT_LOG_L2CAP_TRACE_LEVEL 6
#define CONFIG_BT_LOG_RFCOMM_TRACE_LEVEL_VERBOSE 1
#define CONFIG_BT_LOG_RFCOMM_TRACE_LEVEL 6
#define CONFIG_BT_LOG_SDP_TRACE_LEVEL_VERBOSE 1
#define CONFIG_BT_LOG_SDP_TRACE_LEVEL 6
#define CONFIG_BT_LOG_GAP_TRACE_LEVEL_VERBOSE 1
#define CONFIG_BT_LOG_GAP_TRACE_LEVEL 6
...
#define CONFIG_BT_LOG_A2D_TRACE_LEVEL_VERBOSE 1
#define CONFIG_BT_LOG_A2D_TRACE_LEVEL 6
#define CONFIG_BT_LOG_AVDT_TRACE_LEVEL_VERBOSE 1
#define CONFIG_BT_LOG_AVDT_TRACE_LEVEL 6
#define CONFIG_BT_LOG_AVCT_TRACE_LEVEL_VERBOSE 1
#define CONFIG_BT_LOG_AVCT_TRACE_LEVEL 6
#define CONFIG_BT_LOG_AVRC_TRACE_LEVEL_VERBOSE 1
#define CONFIG_BT_LOG_AVRC_TRACE_LEVEL 6
#define CONFIG_BT_LOG_MCA_TRACE_LEVEL_VERBOSE 1
#define CONFIG_BT_LOG_MCA_TRACE_LEVEL 6
#define CONFIG_BT_LOG_HID_TRACE_LEVEL_VERBOSE 1
#define CONFIG_BT_LOG_HID_TRACE_LEVEL 6
#define CONFIG_BT_LOG_APPL_TRACE_LEVEL_VERBOSE 1
#define CONFIG_BT_LOG_APPL_TRACE_LEVEL 6
#define CONFIG_BT_LOG_GATT_TRACE_LEVEL_VERBOSE 1
#define CONFIG_BT_LOG_GATT_TRACE_LEVEL 6
#define CONFIG_BT_LOG_SMP_TRACE_LEVEL_VERBOSE 1
#define CONFIG_BT_LOG_SMP_TRACE_LEVEL 6
#define CONFIG_BT_LOG_BTIF_TRACE_LEVEL_VERBOSE 1
#define CONFIG_BT_LOG_BTIF_TRACE_LEVEL 6
#define CONFIG_BT_LOG_BTC_TRACE_LEVEL_VERBOSE 1
#define CONFIG_BT_LOG_BTC_TRACE_LEVEL 6
#define CONFIG_BT_LOG_OSI_TRACE_LEVEL_VERBOSE 1
#define CONFIG_BT_LOG_OSI_TRACE_LEVEL 6
#define CONFIG_BT_LOG_BLUFI_TRACE_LEVEL_VERBOSE 1
#define CONFIG_BT_LOG_BLUFI_TRACE_LEVEL 6
...
#define CONFIG_BTDM_CTRL_BR_EDR_MAX_ACL_CONN 1
#define CONFIG_BTDM_CTRL_BR_EDR_MAX_SYNC_CONN 1
#define CONFIG_BTDM_CTRL_BR_EDR_SCO_DATA_PATH_HCI 1
...
#define CONFIG_BTDM_CTRL_BR_EDR_MAX_ACL_CONN_EFF 1
...
#define CONFIG_ESP_SYSTEM_EVENT_QUEUE_SIZE 64
